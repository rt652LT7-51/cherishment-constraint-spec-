# CHANGELOG.md — Deposit Ledger

One line per deposit: date, file, version, review status. This ledger is the repo's provenance spine; nothing enters the repo without a line here.

| Date | File | Version | Review status |
|---|---|---|---|
| 2026-07-02 | CHERISHMENT-NONFUNGIBILITY-CONSTRAINT.md | v0.5 | Protocol complete: Gemini/Grok adversarial passes (v0.2–v0.4); Perplexity prior-art validation; novelty claims narrowed per standing rule. Open ticket: Cultivated Companion targeted prior-art query. |
